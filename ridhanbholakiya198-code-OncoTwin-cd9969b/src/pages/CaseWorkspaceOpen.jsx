            ...
            <div className="space-y-4">
              {result.hypotheses.map((h, i) => (
                <div key={i} className={`border ${h.anchorChanged ? 'border-theoretical' : 'border-border'} rounded p-3`}>
                  <div className="flex items-start justify-between gap-3 mb-1.5 max-sm:flex-col">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-[11px] text-muted font-mono max-sm:grid-cols-1">
